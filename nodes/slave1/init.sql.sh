...
CREATE USER IF NOT EXISTS 'other_usr'@'%' IDENTIFIED BY 'other_password' REQUIRE SSL;
ALTER USER 'other_usr'@'%' REQUIRE ISSUER '/CN=mariadb_ca' AND SUBJECT '/CN=mariadb_client';
