...
## Create secret
echo $MAXSCALE_PORT | sudo docker secret create db_port -
echo "mariadb_maxscale" | sudo docker secret create db_host -
echo "super_adm" | sudo docker secret create db_superadmin -
echo $SUPERADMIN_PASSWORD | sudo docker secret create db_superadmin_paswd -
echo "super_usr" | sudo docker secret create db_superuser -
echo $SUPERUSER_PASSWORD | sudo docker secret create db_superuser_paswd -